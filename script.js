...
var ctrlUp = document.querySelector(".up");
var ctrlDown = document.querySelector(".down");
var ctrlLeft = document.querySelector(".left");
var ctrlRight = document.querySelector(".right");
...
ctrlUp.addEventListener("click", function() {
    turnBtn(2);
});
ctrlRight.addEventListener("click", function() {
    turnBtn(3);
});
ctrlDown.addEventListener("click", function() {
    turnBtn(4);
});
